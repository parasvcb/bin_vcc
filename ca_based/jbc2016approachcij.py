...
mat1contact=add1+"general/contactmaps_numpymatrices/cacanonloc_10ang75pcntframes_.npyob.npy"
mat2contact=add2+"general/contactmaps_numpymatrices/cacanonloc_10ang75pcntframes_.npyob.npy"
mat3contact=add3+"general/contactmaps_numpymatrices/cacanonloc_10ang75pcntframes_.npyob.npy"
...
for i in range(0,len(mat1)): 
     for j in range(0,len(mat1[i])):
         ...
         val2=mat2[i][j]
         val3=mat3[i][j]
         cond = abs(val1)>=cuttcij and abs(val2)>=cuttcij and abs(val3)>=cuttcij
         if cond:
