    ...
    library(bio3d)
    library(igraph)
    load('../../derived/ensy321a/general/netob_CA/jbc2016approach_nonlocalcaca0.5cij/consensusnet_opt_mod_MEAN.ob')
    a=read.csv('../../derived/ensy321a/general/netob_CA/jbc2016approach_nonlocalcaca0.5cij/consensusnet_opt_mod_MEAN.amendedvectorlist',header=FALSE)
    ...
    netamend <- network.amendment(netmean, a$V1, "mean")
    save(netamend,file='../../derived/ensy321a/general/netob_CA/jbc2016approach_nonlocalcaca0.5cij/amendmentconsensusnet_opt_mod_MEAN.ob')
