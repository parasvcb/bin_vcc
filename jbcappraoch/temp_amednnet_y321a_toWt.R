    ...
    library(bio3d)
    library(igraph)
    load('../../../Y321A_series/output_process_renumberpdb_aligned/jbcapproach/original/net_max_mod.ob')
    a=read.csv('../../../Y321A_series/output_process_renumberpdb_aligned/jbcapproach/pseudo_WT_membership',header=FALSE)
    ...
    netamend <- network.amendment(net, a$V1, "max")
    net <- netamend
    save(net,file='../../../Y321A_series/output_process_renumberpdb_aligned/jbcapproach/net_max_mod.ob')
