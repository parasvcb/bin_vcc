...
fupp, flow = [False, False] if framescutt == "False" else list(
...
if range_cutt_val == False:
    uprange, lowrange = list(map(float, rangecutt.split(":")))
    mat = matrix_returner_range_cuttoff(
        numpyhas, distcutt, uprange, lowrange, fupp, flow)
else:
    print(distcutt, range_cutt_val, fupp, flow)
